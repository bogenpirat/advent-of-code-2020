...
for group in groups:
    ...
    groupsAnswers.append(len(groupAnswers))

print(f'sum(groupsAnswers)={sum(groupsAnswers)}')
...
for group in groups:
    ...
    for person in people:
        ...
        peopleAnswers.append(personAnswers)
    
    groupsAnswers.append(len(peopleAnswers[0].intersection(*peopleAnswers)))
